defmodule ExMink.PromEx do
  ...
  3. Update your `endpoint.ex` file to expose your metrics (or configure a standalone
     ...
     ```
     defmodule ExMinkWeb.Endpoint do
       use Phoenix.Endpoint, otp_app: :ex_mink
  ...
  def plugins do
    [
      ...
      Plugins.Application,
      Plugins.Beam,
      # {Plugins.Phoenix, router: ExMinkWeb.Router, endpoint: ExMinkWeb.Endpoint},
      Plugins.Ecto,
      # Plugins.Oban,
  ...
  def dashboards do
    [
      ...
      # {:ex_mink, "/grafana_dashboards/user_metrics.json"}
    ]
  end
end
